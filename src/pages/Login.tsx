...
import { Zap, Mail, Lock, ChevronRight, AlertCircle } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#050505] text-white flex flex-col justify-center items-center px-6 relative overflow-hidden">
            ...
            >
                    ...
                    <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-sm font-bold text-white/70 uppercase tracking-widest">Password</label>
                ...
                <p className="text-center mt-8 text-white/40 text-sm font-medium">
                    ...
                    <Link to="/signup" className="text-primary font-bold hover:text-primary/80 transition-colors">Sign up for free</Link>
                </p>
            </motion.div>
        </div>
    );
